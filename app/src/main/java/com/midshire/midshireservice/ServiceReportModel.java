...
public class ServiceReportModel {
    ...
    public String getNatureOfCallOut() {
        return natureOfCallOut;
    }

    public void setNatureOfCallOut(String natureOfCallOut) {
        this.natureOfCallOut = natureOfCallOut;
    }
    ...
    public String getCalloutstdot() {
        return calloutstdot;
    }

    public void setCalloutstdot(String calloutstdot) {
        this.calloutstdot = calloutstdot;
    }
